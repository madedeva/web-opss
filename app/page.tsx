...
export default function Home () {
    ...
    const openVideo = () => {
        const url = 'https://www.youtube.com/watch?v=0z2GvNPU5Rw&t=1s';
    ...
    return (
        <SessionProvider>
            ...
            <main>
                <section
                    className="bg-blue-950 text-white text-center py-10"
                    id="top-section"
                    style={{
                        backgroundImage: `url('https://images.unsplash.com/photo-1593642634443-44adaa06623a')`,
                    ...
                    <div className="mt-12 mb-12">
                        ...
                        <button
                            className="bg-orange-500 text-white py-2 px-6 rounded flex items-center transform transition duration-300 hover:scale-105"
                ...
                <section className="bg-blue-950 text-white py-20" id="conference">
                    <div className="container mx-auto text-center flex flex-col items-center">
                        ...
                        <GetAllConference />
                        <a href="/dashboard/availableconference">
                ...
                <form className="max-w-xl mx-auto">
                    <input type="text" placeholder="Your name" className="w-full mb-4 p-2 bg-white border rounded" />
                    <input type="email" placeholder="Your email" className="w-full mb-4 p-2 bg-white border rounded" />
                    <textarea placeholder="Your message" className="w-full mb-4 p-2 bg-white border rounded" rows={4}></textarea>
                    <div className="flex justify-center">
